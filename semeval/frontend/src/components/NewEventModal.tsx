...
export function NewEventModal({ onClose, onCreate }: NewEventModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4 backdrop-blur-sm">
      <div className="glass-card max-w-md w-full p-6 flex flex-col gap-5 border border-ink/20">
        <h3 className="text-xl font-bold text-ink">New Event</h3>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            <input
              ...
              className="w-full rounded-xl border border-ink/10 bg-surface-900 px-4 py-3 text-sm text-ink focus:border-brand-500 focus:outline-none"
            />
          </div>
